document.addEventListener("DOMContentLoaded", function () {
    ...
    // Function to scroll to the bottom of the conversation history
    function scrollToBottom() {
        conversationHistoryElement.scrollTop = conversationHistoryElement.scrollHeight;
    }

    // Add an event listener to the "Ask" button
    askButton.addEventListener("click", function () {
        handleUserInput();
    });

    // Add an event listener to the input field to capture Enter key press
    ...
    // Function to handle user input (common logic for button click and Enter key press)
...
// Rest of your code for WebGL animation and other functionality...
